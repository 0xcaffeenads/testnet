...
public class ItemSpriteSheet {
	...
	public static final int FALCHION		= 133; // new
	...
	public static final int ARMOR_CHAIN		= 134; // new
	...
	public static final int WAND_REDWOOD		= 132; // new
	public static final int WAND_ROSEWOOD		= 139; // new
	...
	public static final int RING_GARNET_DARK	= 136; // new
	...
	// New: added row 16 of items.png (indices 128-135) for community-added items
	public static final int POTION_SLATE		= 128;
	public static final int POTION_CYAN		= 129;
	public static final int POTION_VIOLET		= 137; // new
	...
	public static final int SCROLL_KENAZ	= 130; // new
	public static final int SCROLL_EIHWAZ	= 131; // new
	public static final int SCROLL_JERAN	= 138; // new
