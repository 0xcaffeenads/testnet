...
import com.watabou.pixeldungeon.items.rings.RingOfTenacity;
...
public class Hero extends Char {
	...
	public int dr() {
		...
		// new: Ring of Tenacity - flat passive DR bonus per ring level
		for (Buff buff : buffs( RingOfTenacity.Tenacity.class )) {
			dr += ((RingOfTenacity.Tenacity)buff).level;
		}
		return dr;
	}
