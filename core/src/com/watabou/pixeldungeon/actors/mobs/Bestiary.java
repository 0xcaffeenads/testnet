...
public class Bestiary {
	...
	public static Mob mutable( int depth ) {
		...
		if (Random.Int( 30 ) == 0) {
			if (cl == Rat.class) {
				...
				cl = SkeletonChampion.class;
			} else if (cl == Crab.class) {
				cl = CrabMatriarch.class;
			} else if (cl == Gnoll.class) {
				cl = GnollWarlord.class;
			}
		}
	...
	private static Class<?> mobClass( int depth ) {
		...
		case 3:
			...
			break;
		case 4:
			chances = new float[]{ 1, 2, 3,   0.02f, 0.01f, 0.01f,   0.01f };
			classes = new Class<?>[]{ Rat.class, Gnoll.class, Crab.class,   Swarm.class, Skeleton.class, Thief.class,   RatKing.class };
			break;
