...
public abstract class Wand extends KindOfWeapon {
	...
	private static final String[] woods = 
		{"holly", "yew", "ebony", "cherry", "teak", "rowan", "willow", "mahogany", "bamboo", "purpleheart", "oak", "birch", "redwood", "rosewood"};
	private static final Integer[] images = {
		...
		ItemSpriteSheet.WAND_REDWOOD,
		ItemSpriteSheet.WAND_ROSEWOOD};
